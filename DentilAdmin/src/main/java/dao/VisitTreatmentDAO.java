...
public class VisitTreatmentDAO {
	...
	private static final String SQL_DELETE_WITH_IDDENTIST = "delete from VisitTreatment as v where v.idVisit in (select id from visit as vi where vi.idDentist=?)";
