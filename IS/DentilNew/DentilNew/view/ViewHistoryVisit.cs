...
{
    public partial class ViewHistoryVisit : MaterialForm
    {
        private int idVisit;
        private List<HistoryVisitDTO> arrLastSeen = new List<HistoryVisitDTO>();

        public ViewHistoryVisit(int idVisit)
        {
        ...
        private void configure()
        {
            ...
            foreach (HistoryVisitDTO i in this.arrLastSeen)
            {
