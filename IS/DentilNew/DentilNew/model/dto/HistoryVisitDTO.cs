...
{
    public class HistoryVisitDTO : CommonNameSurname
    {
        private int idVisit;
        ...
        public HistoryVisitDTO(int idVisit, string idDentist) : base()
        {
            this.idVisit = idVisit;
            this.idDentist = idDentist;
        }

        public HistoryVisitDTO(int idVisit, string dateWhen, string timeWhen, string idDentist) : base()
        {
            this.idVisit = idVisit;
        ...
        public HistoryVisitDTO(int idVisit, string dateWhen, string timeWhen, string idDentist, string dentistName, string dentistSurname) : base(dentistName, dentistSurname)
        {
            this.idVisit = idVisit;
            this.dateWhen = dateWhen;
            this.timeWhen = timeWhen;
