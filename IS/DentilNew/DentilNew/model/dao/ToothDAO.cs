...
namespace DentilNew.model.dao
{
    ...
    {
        private static readonly string SQL_SELECT = "select id from tooth as t where t.active=1";
        private static readonly string SQL_INSERT = "insert into tooth values(@id)";
        private static readonly string SQL_UPDATE = "update tooth as t set t.active=0 where t.id=@id";
