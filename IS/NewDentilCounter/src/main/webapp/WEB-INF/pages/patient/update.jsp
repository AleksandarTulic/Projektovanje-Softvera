    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="Patient?what=updatePatient" method="POST" id="formUpdatePatient">
                	<div class="row">
                		<div class="col-sm-6">
                		...
                		<div class="col-sm-6">
                			<div class="form-group">
		                        ...
		                        <div>
		                            <input id="updateEmail"  type="email" class="form-control" name="email" maxlength="200" value=""> <!-- OVO VRSI REGEX VALIDACIJU AUTOMATSKI -->
		                        </div>
                			</div>
                			...
                			<div class="form-group">
		                        ...
		                        <div>
		                            <input id="updatePhone" pattern="[0-9]{2,}"  type="text" class="form-control" maxlength="30" name="phone" value="">
		                        </div>
                			</div>
                			...
                			<div class="form-group">
		                        ...
		                        <div>
		                            <input id="updateAddress" pattern="^[a-zA-Z]{2,}[0-9a-zA-Z\s]*"  type="text" maxlength="250" class="form-control" name="address" value="">
		                        </div>
                			</div>
                		</div>
                	</div>
                    ...
                    <div class="form-group">
                    	<div class="row">
	                        ...
	                        <div class="col-sm-4" style="text-align: center">
	                            <input onclick="update()" type="button" class="btn normalButton" value="Update">
	                        </div>
